...
public class TemperatureHub : Hub
{
    ...
    public async Task ReceiveTempData(string encryptedData)
	{
		try
		{
			...
			Console.WriteLine($"Received temperature forecast - Date: {forecast.Date}, Temperature: {forecast.TemperatureC}, Summary: {forecast.Summary} Axel testar");
